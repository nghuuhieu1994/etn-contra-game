...
void DemoState::Render(LPD3DXSPRITE _lpDSpriteHandle)
{
		...
		//billmove5[1]->Render(_lpDSpriteHandle, D3DXVECTOR2(_x_1 - 50, _y_1 + 70), eSpriteEffect::Horizontally, 0.0f, 1.0f, 1.0f);
		//billmove5[2]->Render(_lpDSpriteHandle, D3DXVECTOR2(_x_1 + 70, _y_1 + 100), eSpriteEffect::Vertically, 0.0f, 1.0f, 1.0f);
